...
class MenuItem extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('title, href, description', 'length', 'max'=>300),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, parent_id, menu_id, title, href, type, sort, status, description', 'safe', 'on'=>'search'),
        );
    }
    ...
    {
        return array(
            'FirstLevelOfTopMenu' => array('condition' => 'menu_id=3 and parent_id = 0 and status=1', 'order'=>'sort'),
            'SubLevelsOfTopMenu' => array('condition' => 'menu_id=3 and parent_id <> 0 and status=1', 'order'=>'sort'),
            'FirstLevelOfBottomMenu' => array('condition' => 'menu_id=4 and parent_id = 0 and status=1', 'order'=>'sort'),
            'SubLevelsOfBottomMenu' => array('condition' => 'menu_id=4 and parent_id <> 0 and status=1', 'order'=>'sort'),
